...
function constelacion(d, occ) {
  ...
  <div class="photo-ring"><div class="photo-gap"><div class="photo-frame">${d.photo ? `<img class="photo-img" src="${d.photo}" alt="">` : '<div class="ph-placeholder">Foto</div>'}</div></div></div>
